...
class InfluxDBHandler:
    ...
    def query_latest_from_database(self, measurement: str, field: str, tags: dict=None, start: str="0", stop: str='now()') -> object:
        """
    ...
    # def delete_from_database():  # Too be implemented (TBI): Will delete selected / queried datapoints from database.
    
    # def custom_flux_query():  # TBI: Will allow for custom queries to the database using the Flux language syntax.
