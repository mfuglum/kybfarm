# Henter sensor data
from edge.src.sensor_interfaces import sensor_CO2_VOC_modbus # Sensoren før varmebatteri
from edge.src.sensor_interfaces import sensor_CO2_VOC_modbus1 # Sensoren etter varmebatteri
...
sensor2 = sensor_CO2_VOC_modbus1.CO2_VOC() # Henter klassen CO2_VOC 
